...
class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        jpaProperties.put("hibernate.connection.characterEncoding", characterEncoding);
        jpaProperties.put("hibernate.connection.useUnicode", useUnicode);
